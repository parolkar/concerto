...
class MapResponse extends AExpression {

    //attributes
    public $identifier = "";
    public static $name = "mapResponse";
    ...
    public function get_R_code() {
        return sprintf('concerto:::concerto.qti.mapResponse'."('result$%s')", addcslashes($this->identifier, "'"));
    }
