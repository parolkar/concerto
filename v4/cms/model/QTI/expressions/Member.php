...
class Member extends AExpression {
    ...
    public function get_R_code() {
        ...
        $code = "if(is.null(" . $exp1 . ") || is.null(" . $exp2 . ")) NULL else { ".'concerto:::concerto.qti.contains'."(" . $exp2 . "," . $exp1 . ",'" . $exp1->get_baseType . "','" . $exp1->get_cardinality . "') }";
        return $code;
    }
