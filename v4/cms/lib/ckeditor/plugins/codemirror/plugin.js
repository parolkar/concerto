...
(function () {
    CKEDITOR.plugins.add('codemirror', {
        ...
        init: function (editor) {
            ...
            CKEDITOR.document.appendStyleSheet(rootPath + '../../../CodeMirror/lib/codemirror.css');

            if (codeMirrorTheme.length && codeMirrorTheme != 'default') {
                // Load codemirror theme
                CKEDITOR.document.appendStyleSheet(rootPath + '../../../CodeMirror/theme/' + codeMirrorTheme + '.css');
            }
            ...
            */
            ...
            editor.addMode('source', function (callback) {
                ...
                window["codemirror_" +  editor.id] = Methods.iniCodeMirror(sourceAreaElement.$, "htmlmixed", false, false);
