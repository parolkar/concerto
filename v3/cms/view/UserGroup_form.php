...
$edit_caption = Language::string(152);
$new_caption = Language::string(153);
//////////
        ...
        <div class="divFormElement">
            <table class="fullWidth">
                <tr>
                    ...
                    <td class="tdFormIcon"><span class="tooltip spanIcon ui-icon ui-icon-help" title="<?= Language::string(154) ?>"></span></td>
                    <td>
        ...
        <div class="divFormElement">
            <table class="fullWidth">
                <tr>
                    ...
                    <td class="tdFormIcon"><span class="tooltip spanIcon ui-icon ui-icon-help" title="<?= Language::string(155) ?>"></span></td>
                    <td>
                        <div class="divFormControl">
            ...
            <div class="divFormElement">
                <table class="fullWidth">
                    <tr>
                        ...
                        <td class="tdFormIcon"><span class="tooltip spanIcon ui-icon ui-icon-help" title="<?= Language::string(156) ?>"></span></td>
                        <td>
                            <div class="divFormControl">
                                <select id="form<?= $class_name ?>SelectOwner" class="fullWidth ui-widget-content ui-corner-all">
                                    <option value="0" <?= (!$obj->has_Owner() ? "selected" : "") ?>>&lt;none&gt;</option>
                                    <?php
