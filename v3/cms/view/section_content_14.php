...
<div class="divSectionSummary sortableHandle">
    <table class="fullWidth tableSectionHeader">
        <tr>
            ...
            <td class="tdSectionColumnIcon"><span class="spanIcon ui-icon ui-icon-help tooltip" title="<?= DS_TestSectionType::get_description_by_id(14) ?>"></span></td>
            <td class="tdSectionColumnIcon"></td>
            <td class="tdSectionColumnType"><?= DS_TestSectionType::get_name_by_id(14) ?></td>
            <td class="tdSectionColumnAction">
                <select id="selectQTI_<?= $_POST['counter'] ?>" class="ui-widget-content ui-corner-all fullWidth">
                </select>
            </td>
