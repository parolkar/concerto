...
<div class="divSectionSummary sortableHandle">
    <table class="fullWidth tableSectionHeader">
        <tr>
            ...
            <td class="tdSectionColumnIcon"><span class="spanIcon ui-icon ui-icon-help tooltip" title="<?= DS_TestSectionType::get_description_by_id(16) ?>"></span></td>
            ...
            <td class="tdSectionColumnType"><?= DS_TestSectionType::get_name_by_id(16) ?></td>
            <td class="tdSectionColumnAction">
                <table class="fullWidth">
                    <tr>
                        <td style="width:10px;"><?= Language::string(396) ?></td>
...
<div class="divSectionDetail <?= $_POST['detail'] == 1 || $_POST['oid'] == 0 ? "" : "notVisible" ?>">
    <fieldset class="ui-widget-content" align="center">
        ...
        while (isset($vals[$i])) {
            if ($i == 3) {
                ...
                <tr>
                    ...
                    <td><span class="spanIcon tooltip ui-icon ui-icon-minus" onclick="Test.uiRemoveWhileCond(<?= $_POST['counter'] ?>,<?= $j ?>)" title="<?= Language::string(230) ?>"></span></td>
                </tr>
                <?php
                $i++;
                $j++;
        ...
        <div align="center">
            <table>
                <tr>
                    <td><span class="spanIcon tooltip ui-icon ui-icon-plus" onclick="Test.uiAddWhileCond(<?= $_POST['counter'] ?>)" title="<?= Language::string(229) ?>"></span></td>
                </tr>
            </table>
        </div>
    </fieldset>
