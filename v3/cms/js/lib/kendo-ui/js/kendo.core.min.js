...
t=this.handlers,n=e.element,r=t.length,i=0;for(;i<r;i++)off.apply(n,t[i]);support.touch&&e.element.off("touchstart",e._touchStartProxy).off("touchend",e._touchEndProxy)},_touchStart:function(e){var t=this;t.timeoutID&&(clearTimeout(t.timeoutID),t.timeoutID=null),t.mute=!0},_touchEnd:function(e){var t=this;t.timeoutID=setTimeout(function(){t.mute=!1},400)}},kendo.EventProxy=EventProxy})(jQuery);